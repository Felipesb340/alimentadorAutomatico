...
<body style='background-color:#87CEEB;' >
    ...
    <script>
        var qnt_result_pg = 50; //qtd de registros por pag
        var pagina = 1; //pagina inicial

        $(document).ready(function () {
            listar_dados(pagina, qnt_result_pg);
        });

        function listar_dados(pagina, qnt_result_pg){
            var dados = {
                pagina: pagina, 
                qnt_result_pg: qnt_result_pg
            }
            $.post('listar_dados.php', dados, function(retorna){
